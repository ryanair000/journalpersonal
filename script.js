...
document.querySelector('#clearTrackingData')?.addEventListener('click', () => clearData(['dailyMood', 'habitStreak', 'habitLastComplete', 'customHabits', 'customHabitHistory', 'routineHistory', 'routines', 'mealLogs', 'nutritionNote', 'nutritionHistory', 'studySessions', 'studyTimerSeconds', 'studyTimerHistory', 'weeklyExpenses', 'categoryExpenses', 'expenseLedger', 'incomeEntries', 'prayerHistory', 'moodHistory', 'mentalHealthHistory', 'workoutHistory', 'rhythmHistory', 'unitProgress', 'contentAccounts', 'accountAnalyticsHistory', 'contentIdeas', 'customUnits', 'schoolStudyItems', 'schoolResearchItems', 'schoolProjectDetails', 'projectMilestones', 'classEntries', 'examEntries', 'personalBusinesses', 'businessStatuses', 'workGoals', 'workDeadlines', 'workLogEntries', 'peopleDirectory', 'peopleCheckins', 'peopleContactHistory', 'peopleNoteHistory', 'relationshipFeelHistory', 'examPrepItems', 'businessKpis', 'careerTasks', 'analyticsHistory', 'recurringExpenses', 'monthlyBudget'], 'tracking and added items'));
