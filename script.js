...
document.querySelector('#clearTrackingData')?.addEventListener('click', () => clearData(['dailyMood', 'habitStreak', 'habitLastComplete', 'customHabits', 'customHabitHistory', 'routineHistory', 'routines', 'mealLogs', 'nutritionNote', 'nutritionHistory', 'studySessions', 'studyTimerSeconds', 'studyTimerHistory', 'weeklyExpenses', 'categoryExpenses', 'expenseLedger', 'incomeEntries', 'prayerHistory', 'moodHistory', 'mentalHealthHistory', 'workoutHistory', 'rhythmHistory', 'unitProgress', 'contentAccounts', 'accountAnalyticsHistory', 'selectedCreatorAccount', 'contentIdeas', 'myLittleLife.creatorCenter.v1', 'myLittleLife.creatorAccount.active', 'customUnits', 'schoolStudyItems', 'schoolResearchItems', 'schoolProjectDetails', 'projectMilestones', 'classEntries', 'examEntries', 'personalBusinesses', 'businessStatuses', 'workGoals', 'workDeadlines', 'workLogEntries', 'peopleDirectory', 'peopleCheckins', 'peopleContactHistory', 'peopleNoteHistory', 'relationshipFeelHistory', 'relationshipDates', 'examPrepItems', 'examNextActions', 'businessKpis', 'careerTasks', 'analyticsHistory', 'recurringExpenses', 'recurringEvents', 'savingsContributions', 'monthlyBudget'], 'tracking and added items'));
